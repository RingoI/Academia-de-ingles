    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PATCH, "/alumnos/**").hasAnyRole("ADMIN", "DOCENTE")
                ...
                .requestMatchers(HttpMethod.GET, "/asistencias/**").hasAnyRole("ADMIN", "DOCENTE")
                .requestMatchers(HttpMethod.POST, "/asistencias/**").hasAnyRole("ADMIN", "DOCENTE")
