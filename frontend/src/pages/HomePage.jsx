		...
		<div className=" w-full h-screen">
			...
			<div className="min-h-150 bg-slate-100 px-5 py-16">
				<div>
					...
					<p className="text-slate-600 py-5">
						Selecciona el nivel que impulsará tu carrera. Clases presenciales o virtuales, <br /> materiales de calidad y
						certifiación oficial
					</p>
				</div>
			...
			<div className="relative h-[calc(100vh-4.5rem)] w-full flex bg-slate-50 items-center py-16 overflow-hidden px-5">
				...
				<div className="w-[40%] flex flex-col justify-center gap-3 h-full z-10">
					<h2 className="text-5xl text-[#0a2540]">
						Tu pasaporte al <br /> mundo con <span className="text-5xl text-[#1b95d3]">Anglia Examinations.</span>
					</h2>
					<p className="text-slate-600 ">
						Anglia ofrece una estructura escalonada de exámenes de inglés que cubren todas las etapas del aprendizaje, desde los
						niveles más básicos hasta el dominio experto (C2). Al elegir Providence Institue, te aseguras una formación diseñada
						específicamente para superar estos desafíos internacionales
					</p>
				...
				<div className="grid grid-cols-2 w-[60%] place-items-center gap-5 z-10">
					<CardAnglia
						...
						descripcion={"Institución con base en el Reino Unido con más de 30 años de trayectoria global"}
						Icono={Sparkles}
					/>
					<CardAnglia
						cambioFondo={true}
						...
						descripcion={"Contamos con la habilitación oficial para administrar los exámenes en nuestras sedes o de forma remotra."}
					/>
					<CardAnglia
						Icono={Footprints}
						titulo={"Niveles Step-by-Step"}
						descripcion={"Desde el First Step hasta Mastery, una ruta clara de crecimiento para niños y adultos."}
					/>
					<CardAnglia
						Icono={Globe}
						titulo={"Validez sin Vencimiento"}
						descripcion={"A diferencia de otros exámenes, los certificados de Anglia no caducan, acompañándote siempre."}
					/>
				</div>
			</div>
			<div className="h-50 bg-white flex p-5 items-center justify-between">
				<div className="flex flex-col">
					...
					<span className="text-[#0a2540] font-semibold">providenceinstituto@gmail.com</span>
				</div>
				<div className="flex flex-col">
					<span className="text-[#1b95d3] font-semibold">TELÉFONO</span>
					<span className="text-[#0a2540] font-semibold">+54 9 11 3624-820112</span>
				</div>
				<div className="flex flex-col">
					<span className="text-[#1b95d3] font-semibold">DIRECCIÓN</span>
					<span className="text-[#0a2540] font-semibold">Carlos Urioste 688, Capitan Sarmiento, Buenos Aires</span>
				</div>
			</div>
			<Footer />
		</div>
