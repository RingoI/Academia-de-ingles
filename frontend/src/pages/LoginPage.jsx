...
function LoginPage() {
	return (
		<div class="absolute top-0 z-[-2] h-screen w-screen bg-[#030d18] bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(31,30,87,0.7),rgba(255,255,255,0))]">
			<div className="w-full gap-5 flex items-center flex-col justify-center h-full">
				...
				<div className="h-100 bg-[##0b1423] w-100 rounded-4xl p-8 border border-slate-800 justify-center shadow-xl shadow-blue-400/10">
					...
					<div className="h-70 justify-between flex w-full items-center flex-col">
						<form action="" className="w-full h-full flex gap-5 justify-center items-center flex-col ">
						...
						<button className="bg-[#00b5ddb8] cursor-pointer font-semibold  transition-transform hover:translate-y-1 text-[#030d18] w-full h-12 rounded-2xl">
							Iniciar Sesion
						</button>
					</div>
				</div>
