        ...
        <tbody className="bg-[#0c1224]">
          {materiales.map((m, idx) => (
            <tr key={m.id}>
              ...
              <th>
                {m.tipo === "MATERIAL" ? (
                  <span className="bg-[#818df851] px-2 rounded-xl text-[#818df8ef]">
                    MATERIAL
                  </span>
                ) : (
                  <>
                    {m.tipo === "TAREA" ? (
                      <span className="bg-[#06b5d446] px-3 rounded-xl text-[#06b6d4]">
                        TAREA
                      </span>
                    ) : (
                      <span className="bg-[#db80363e] px-3 rounded-xl text-[#db7f36]">
                        EXAMEN
                      </span>
                    )}
                  </>
