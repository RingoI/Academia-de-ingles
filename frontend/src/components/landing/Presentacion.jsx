...
function Presentacion() {
	return (
		<div className="bg-[#030d18] bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(31,30,87,0.7),rgba(255,255,255,0))] w-full h-screen flex pt-18 items-center px-12">
