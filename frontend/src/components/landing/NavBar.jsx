			...
			<div>
				<ul className="w-[33.3%] flex gap-10 font-semibold text-slate-500">
					<li className="cursor-pointer relative group">
						<span className="transition-colors duration-300 group-hover:text-[#1b95d3]">Inicio</span>
						<span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-[#1b95d3] transition-all duration-300 group-hover:w-full"></span>
					</li>
					<li className="cursor-pointer relative group">
						<span className="transition-colors duration-300 group-hover:text-[#1b95d3]">Cursos</span>
						<span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-[#1b95d3] transition-all duration-300 group-hover:w-full"></span>
					</li>
					<li className="cursor-pointer relative group">
						<span className="transition-colors duration-300 group-hover:text-[#1b95d3]">Nosotros</span>
						<span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-[#1b95d3] transition-all duration-300 group-hover:w-full"></span>
					</li>
					<li className="cursor-pointer relative group">
						<span className="transition-colors duration-300 group-hover:text-[#1b95d3]">Contacto</span>
						<span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-[#1b95d3] transition-all duration-300 group-hover:w-full"></span>
					</li>
				</ul>
			</div>		
